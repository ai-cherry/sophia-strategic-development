...
class GitHubSecretsManager:
    ...
    def update_all_secrets(self):
        ...
        secrets = {
            ...
            "ESTUARY_API_TOKEN": os.getenv(
                "ESTUARY_API_TOKEN", "your-estuary-api-token"
            ),
            "ESTUARY_ACCESS_TOKEN": os.getenv(
                "ESTUARY_ACCESS_TOKEN", "your-estuary-access-token"
            ),
            # Gong API Credentials
            "GONG_ACCESS_KEY": os.getenv("GONG_ACCESS_KEY", "your-gong-access-key"),
            "GONG_ACCESS_KEY_SECRET": os.getenv(
                "GONG_ACCESS_KEY_SECRET", "your-gong-access-key-secret"
            ),
            # HubSpot API Credentials
            "HUBSPOT_API_TOKEN": os.getenv(
                "HUBSPOT_API_TOKEN", "your-hubspot-api-token"
            ),
            "HUBSPOT_CLIENT_SECRET": os.getenv(
                "HUBSPOT_CLIENT_SECRET", "your-hubspot-client-secret"
            ),
            # Vercel Deployment
            "VERCEL_ACCESS_TOKEN": os.getenv(
            ...
            "SNOWFLAKE_SCHEMA": os.getenv(
                "SNOWFLAKE_SCHEMA", "CONVERSATION_INTELLIGENCE"
            ),
            # Webhook Configuration
            "GONG_WEBHOOK_BASE_URL": os.getenv(
                "GONG_WEBHOOK_BASE_URL", "https://your-sophia-platform.com"
            ),
            "GONG_WEBHOOK_JWT_PUBLIC_KEY": os.getenv(
                "GONG_WEBHOOK_JWT_PUBLIC_KEY", "your-jwt-public-key"
            ),
        ...
        for secret_name, secret_value in secrets.items():
            if secret_value and not secret_value.startswith("your-"):
                ...
                logger.warning(
                    f"Skipping {secret_name} - no value provided or using template value"
                )
