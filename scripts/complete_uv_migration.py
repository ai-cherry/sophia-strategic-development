...
class CompleteUVMigration:
    def __init__(self, project_root: Path = None):
        ...
        self.script_patterns = ["scripts/*.py", "scripts/*.sh", "*.sh"]

        self.doc_patterns = ["docs/**/*.md", "*.md"]
    ...
    def update_dockerfile(self, dockerfile_path: Path) -> bool:
        ...
        replacements = [
            ...
            (r"COPY \S+/requirements\.txt \.", "COPY pyproject.toml uv.lock ./"),
            # Add UV installation
            (
    ...
    def update_script(self, script_path: Path) -> bool:
        ...
        if script_path.suffix == ".sh":
            ...
            replacements = [
                ...
                (r'"uv add -r requirements\.txt"', '"uv sync"'),
                (r'"uv add', '"uv add'),
            ]
    ...
    def update_documentation(self, doc_path: Path) -> bool:
        ...
        replacements = [
            ...
            (
                r"Install dependencies.*requirements\.txt",
        ...
        for compose_file in compose_files:
            if compose_file.exists():
                ...
                updated_content = re.sub(
                    r"dockerfile: Dockerfile", "dockerfile: Dockerfile.uv", content
                )
...
"""
    ...
    def run_complete_migration(self) -> dict[str, int]:
        ...
        stats = {"dockerfiles": 0, "workflows": 0, "scripts": 0, "docs": 0, "total": 0}
