...
class CriticalInfrastructureFixer:
    ...
    def fix_snowflake_connectivity(self) -> bool:
        ...
        try:
            ...
            pulumi_commands = [
                ...
                ["pulumi", "env", "set", "scoobyjava-org/default/sophia-ai-production", "snowflake_warehouse=SOPHIA_AI_WH"]
            ]
            ...
            self.fixes_applied.append("Snowflake Connectivity Crisis - Account corrected to ZNB04675")
            return True
    ...
    def _update_infrastructure_files(self):
        ...
        if estuary_env_file.exists():
            ...
            content = content.replace("SNOWFLAKE_ACCOUNT=UHDECNO-CVB64222", "SNOWFLAKE_ACCOUNT=ZNB04675")
        ...
        if deploy_foundation_file.exists():
            ...
            content = content.replace('"account": "UHDECNO-CVB64222"', '"account": "ZNB04675"')
