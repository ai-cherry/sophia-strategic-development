...
NOTE: This security assessment is designed for a user base of 5–100 users. Risk models, threat scenarios, and recommendations are tuned for this scale and can be updated as the user base grows.
"""
...
"""
        ...
        if result.critical_count > 0:
            ...
            summary += "🟠 HIGH: Urgent attention needed\n"
        elif result.medium_count > 0:
            summary += "🟡 MEDIUM: Should be addressed soon\n"
