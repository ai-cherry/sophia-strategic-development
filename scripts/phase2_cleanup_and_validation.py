    ...
    def __init__(self, project_root: str):
        ...
        self.cleanup_targets = {
            "deprecated_services": [
                ...
                "backend/services/snowflake_cortex_service.py",  # Replaced by V3
            ],
            "deprecated_imports": [
                "from backend.services.unified_memory_service import",
                "from backend.services.snowflake_cortex_service import",
                "import snowflake_unified",
        ...
        for file_path in python_files:
            try:
                ...
                replacements = {
                    ...
                    "from backend.services.snowflake_cortex_service import": "# DEPRECATED - Use UnifiedMemoryServiceV3",
                    "CORTEX.EMBED_TEXT_768": "# DEPRECATED - Use GPU embeddings via UnifiedMemoryServiceV3",
                    "snowflake_unified": "# DEPRECATED - Use UnifiedMemoryServiceV3"
                }
        ...
        for file_path in python_files:
            try:
                ...
                deprecated_patterns = [
                    ...
                    r'from backend\.services\.snowflake_cortex_service import',
