...
def fix_syntax_errors():
    ...
    content = content.replace('command_lower = command.lower().\n', 'command_lower = command.lower()\n')
    ...
    content = content.replace('pulumi.export("bucket_name", bucket.id)""",', 'pulumi.export("bucket_name", bucket.id)"""')
    content = content.replace('pulumi.export("public_ip", instance.public_ip)""",', 'pulumi.export("public_ip", instance.public_ip)"""')
    content = content.replace('pulumi.export("deployment_name", deployment.metadata.name)""",', 'pulumi.export("deployment_name", deployment.metadata.name)"""')
