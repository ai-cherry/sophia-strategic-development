...
Current size: 820 lines

Recommended decomposition:
- deploy_cli_sdk_enhancements_core.py - Core functionality
- deploy_cli_sdk_enhancements_utils.py - Utility functions
- deploy_cli_sdk_enhancements_models.py - Data models
- deploy_cli_sdk_enhancements_handlers.py - Request handlers
