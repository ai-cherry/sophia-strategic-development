...
def demonstrate_workflow():
    ...
    for action, insight in user_actions:
        ...
        if action == "APPROVE":
            ...
            insight.insight = f"{insight.insight} - Confirmed by product team, fix in Q2 2024"
            insight.status = "approved"
            print(f"  → Edited and added to knowledge base")
    ...
    for interaction in chat_interactions:
        ...
        print(f"        [Source: {interaction['source']} | Confidence: {interaction['confidence']:.0%}]")
