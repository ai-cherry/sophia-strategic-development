...
class CursorMCPConfigUpdater:
    ...
    def update_snowflake_admin_server(self):
        ...
        snowflake_admin_config = {
            ...
            "environments": {
                "dev": {"restrictions": "minimal", "confirmation_required": False},
                "staging": {"restrictions": "moderate", "confirmation_required": True},
                "production": {
                    "restrictions": "strict",
                    "confirmation_required": True,
                    "read_only": True,
    ...
    def add_performance_settings(self):
        ...
        performance_settings = {
            "performance": {
                ...
                "caching": {"enabled": True, "ttl": 300, "max_size": 1000},
                "timeouts": {"connection": 10, "request": 30, "keepalive": 60},
            }
        }
    ...
    def generate_configuration_report(self) -> str:
        ...
        if self.config.get("cursor_optimizations", {}).get(
...
def main():
    ...
    parser.add_argument(
        "--config", default="cursor_mcp_config.json", help="Config file path"
    )
    ...
    parser.add_argument(
        "--report", action="store_true", help="Generate configuration report"
    )
