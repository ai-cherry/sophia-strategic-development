...
class DevelopmentInsightsGenerator:
    ...
    def _generate_analysis_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "performance_opportunities": self.analysis_data.get("performance_opportunities", 0),
    ...
    def _generate_quality_insights(self) -> Dict[str, Any]:
        ...
        if quality_score >= 90:
            ...
            quality_level = "fair"
            quality_message = "Code quality is fair but needs attention in several areas."
        else:
    ...
    def _generate_security_insights(self) -> Dict[str, Any]:
        ...
        if security_issues == 0:
            ...
            security_message = f"{security_issues} security issues need immediate attention!"
    ...
    def _generate_performance_insights(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "optimization_potential": "high" if perf_opportunities > 10 else "medium" if perf_opportunities > 5 else "low",
    ...
    def _generate_cursor_insights(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "cursor_readiness": "optimized" if len(optimizations) == 0 else "needs_optimization"
        }
    ...
    def _generate_github_insights(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "status": "well_integrated" if integration_score >= 80 else "needs_enhancement",
    ...
    def _generate_recommendations(self) -> List[str]:
        ...
        quality_score = self.analysis_data.get("quality_score", 0)
        if quality_score < 80:
            recommendations.append("🎯 Improve code quality by adding docstrings and type hints")
        
        # Security recommendations
        security_issues = self.analysis_data.get("security_issues", 0)
        if security_issues > 0:
            recommendations.append("🔒 Address security issues by removing hardcoded secrets")
        ...
        if cursor_optimizations:
            recommendations.append("🔧 Apply Cursor optimizations for better AI integration")
    ...
    def generate_github_comment(self) -> str:
        ...
        comment.append(f"**Performance Opportunities**: {summary['performance_opportunities']}")
        comment.append("")
        ...
        if action_items:
            ...
            for item in action_items:
                ...
                comment.append(f"- {emoji} **{item['title']}** ({item['estimated_time']})")
    ...
    def generate_markdown_report(self) -> str:
        ...
        report.append(f"**Optimization Potential**: {performance['optimization_potential']}")
        report.append("")
        ...
        report.append(f"**Auto-triggers**: {'✅' if mcp['auto_triggers_enabled'] else '❌'}")
        report.append("")
        ...
        report.append(f"**Cursor Workflows**: {'✅' if github['cursor_workflows_enabled'] else '❌'}")
        report.append("")
        ...
        if action_items:
            ...
            for item in action_items:
                report.append(f"### {item['title']} ({item['priority'].title()} Priority)")
...
def main():
    ...
    parser.add_argument("--output-format", choices=["json", "markdown", "github-comment"], 
