...
echo "   scp -i ~/.ssh/sophia_correct_key -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null frontend-deploy.tar.gz ubuntu@192.222.58.232:/tmp/"
echo ""
echo "2. SSH to server:"
echo "   ssh -i ~/.ssh/sophia_correct_key -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ubuntu@192.222.58.232"
echo ""
