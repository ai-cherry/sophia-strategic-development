        ...
        for pattern in patterns:
            ...
            try:
                ...
                if result.stdout:
                    ...
                    files = [f for f in files if f and 
                            f not in STALE_LLM_FILES and 
                            f not in FILES_TO_UPDATE_IMPORTS]
                    if files:
...
def main():
    ...
    print(f"Updated {len(updates)} files with {sum(updates.values())} total replacements")
    print()
