...
def validate_esc_config() -> List[Tuple[bool, str]]:
    ...
    if esc_dir.exists():
        ...
        prod_exists, prod_msg = check_file_exists("infrastructure/esc/sophia-ai-production.yaml")
        results.append((prod_exists, prod_msg))
        
        # Check for base environment
        base_exists, base_msg = check_file_exists("infrastructure/esc/sophia-ai-platform-base.yaml")
