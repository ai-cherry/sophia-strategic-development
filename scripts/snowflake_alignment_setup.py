...
class SnowflakeAlignmentSetup:
    ...
    def connect_to_snowflake(self, attempt: int = 1) -> bool:
        ...
        try:
            ...
            if attempt < 2:
                ...
                logger.error(
                    "❌ Maximum connection attempts reached. Stopping to avoid lockout."
                )
                return False
    ...
    def test_cortex_functions(self):
        ...
        try:
            ...
            result = cursor.fetchone()
            logger.info("✅ Cortex COMPLETE function test successful")
            ...
            result = cursor.fetchone()
            logger.info("✅ Cortex SENTIMENT function test successful")
            ...
            result = cursor.fetchone()
            logger.info("✅ Cortex EXTRACT_ANSWER function test successful")
    ...
    def check_gong_data_share(self):
        ...
        try:
            ...
            if gong_shares:
                ...
                logger.info(
                    "💡 To enable Gong data share, contact Gong support with account: UHDECNO-CVB64222"
                )
...
def main():
    ...
    if success:
        ...
        with open(
            "/home/ubuntu/sophia-project/snowflake_connection_info.json", "w"
        ) as f:
