...
STANDARD_SECRET_NAMES = {
    # Docker - Use DOCKER_TOKEN (not DOCKER_HUB_ACCESS_TOKEN)
    ...
    "DOCKER_ACCESS_TOKEN": "DOCKER_TOKEN",
...
def update_kubernetes_manifests():
    ...
    k8s_files = (
        ...
        glob.glob("kubernetes/**/*.yml", recursive=True)
    )
...
def main():
    print("🚀 Updating ALL workflows, CI/CD, CLI, and configs for consistent secret names")
    print("=" * 80)
