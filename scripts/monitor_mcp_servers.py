...
MCP_SERVERS = [
    ...
    {"name": "Snowflake", "port": 9001, "url": "http://localhost:9001/health"},
...
async def verify_snowflake_connection():
    """Verify Snowflake is receiving data"""
...
async def main():
    ...
    # Verify Snowflake
    await verify_snowflake_connection()
