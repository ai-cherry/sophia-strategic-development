...
class ComprehensiveSyntaxFixer:
        ...
        try:
            ...
            if len(lines) > 45:
                ...
                if 'host=' in line and 'port=' in line and ',' not in line:
                    lines[44] = line.replace('" port=', '", port=').replace("' port=", "', port=")
    ...
    def run(self):
        ...
        error_files = [
            ("start_mcp_servers.py", "expected an indented block after 'try' statement on line 34"),
            ("start_sophia_absolute_fix.py", "invalid syntax. Perhaps you forgot a comma?"),
            ("unified_ai_assistant.py", "invalid syntax"),
            ("sophia_workflow_runner.py", "invalid syntax"),
            ("core/agents/infrastructure/sophia_infrastructure_agent.py", "invalid syntax"),
            ...
            ("infrastructure/mcp_servers/ai_memory_v2/server.py", "invalid syntax. Perhaps you forgot a comma?"),
            ("infrastructure/mcp_servers/notion_simple/server.py", "invalid syntax. Perhaps you forgot a comma?"),
            ("infrastructure/mcp_servers/base/unified_mcp_base.py", "invalid syntax. Perhaps you forgot a comma?"),
