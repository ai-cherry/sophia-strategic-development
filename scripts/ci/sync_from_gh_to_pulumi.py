...
This syncs ALL secrets from ai-cherry GitHub organization to Pulumi ESC environment
"""
...
def sync_secrets_to_pulumi_esc():
    ...
    print(f"🔄 Syncing secrets to Pulumi ESC environment: {esc_environment}")
    ...
    try:
        ...
        if result.returncode == 0:
            print("✅ Successfully synced secrets to Pulumi ESC!")
            ...
            print("❌ Failed to sync secrets to Pulumi ESC")
