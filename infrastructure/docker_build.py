...
registry_info = docker.get_registry_info(
    server=registry_url
)
...
sophia_api_image = docker.Image("sophia-api-image",
...
iac_toolkit_image = docker.Image("iac-toolkit-image",
    build=docker.DockerBuildArgs(
        context="..",
...
mcp_gateway_image = docker.Image("mcp-gateway-image",
    build=docker.DockerBuildArgs(
        context="../mcp-gateway",
