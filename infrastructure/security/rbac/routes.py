...
Current size: 745 lines

Recommended decomposition:
- routes_core.py - Core functionality
- routes_utils.py - Utility functions
- routes_models.py - Data models
- routes_handlers.py - Request handlers
