...
mcp_namespace = k8s.core.v1.Namespace(
    "mcp-servers-ns",
...
pulumi_mcp_deployment = k8s.apps.v1.Deployment(
    "pulumi-mcp-deployment",
...
pulumi_mcp_service = k8s.core.v1.Service(
    "pulumi-mcp-service",
    metadata=k8s.meta.v1.ObjectMetaArgs(
...
k8s_mcp_deployment = k8s.apps.v1.Deployment(
    "k8s-mcp-deployment",
    metadata=k8s.meta.v1.ObjectMetaArgs(
        namespace=mcp_namespace.metadata["name"],
    ),
...
k8s_mcp_service = k8s.core.v1.Service(
    "k8s-mcp-service",
    metadata=k8s.meta.v1.ObjectMetaArgs(
