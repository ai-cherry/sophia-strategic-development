...
lambda_config = {
    "api_key": _require_esc_value(
        esc_env.values, ("infrastructure", "lambda_labs", "api_key")
    ),
    "control_plane_ip": _require_esc_value(
        esc_env.values, ("infrastructure", "lambda_labs", "control_plane_ip")
    ),
    "ssh_key_name": _require_esc_value(
        esc_env.values, ("infrastructure", "lambda_labs", "ssh_key_name")
    ),
}
...
connection = command.remote.ConnectionArgs(
    host=control_plane_ip, user="ubuntu", private_key=ssh_private_key
)
...
def create_mcp_deployment(name: str, image: str):
    ...
    service = k8s.core.v1.Service(
        ...
        spec=k8s.core.v1.ServiceSpecArgs(
            selector=app_labels, ports=[k8s.core.v1.ServicePortArgs(port=9000)]
        ),
