...
cluster = aws.ecs.Cluster("sophia-ai-cluster") # Or get an existing one: aws.ecs.Cluster.get(...)
...
portkey_config_secret = pulumi.Config().set_secret("portkeyFallbackConfig", portkey_fallback_config)
...
pulumi.export("portkey_fallback_config_note", "Fallback config stored in Pulumi secrets. Use `pulumi config get --secret portkeyFallbackConfig` to view.")
