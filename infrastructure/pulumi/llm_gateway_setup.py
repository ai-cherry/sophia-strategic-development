...
openrouter_config = command.local.Command(
    "openrouter-cli-config",
...
# --- Outputs ---
pulumi.export(
    "openrouter_cli_status",
    "OpenRouter configuration managed via Pulumi Command resource (simulation).",
)
