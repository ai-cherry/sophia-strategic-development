...
class GitHubSecretSync:
    ...
    def _load_secret_mappings(self) -> Dict[str, Dict[str, str]]:
        ...
        try:
            ...
            return {
                name: mapping for name, mapping in esc_main.all_secret_mappings.items()
            }
    ...
    def sync_github_to_esc(self) -> Dict[str, Any]:
        ...
        for secret in github_secrets:
            ...
            try:
                ...
                results["synced"] += 1
                logger.info(
                    f"Synced GitHub secret {secret_name} to Pulumi ESC as {esc_name}"
                )
            except Exception as e:
                results["failed"] += 1
