...
from infrastructure.mcp_servers.ai_memory_v2.models.data_models import (
    ...
    BulkMemoryRequest, MemoryUpdateRequest, MemoryCategory
)
...
class AiMemoryV2Handler:
    ...
    async def _check_duplicate(self, content: str, embedding: Optional[np.ndarray]) -> Optional[int]:
    ...
    async def _get_memory_by_id(self, memory_id: int) -> Optional[MemoryEntry]:
