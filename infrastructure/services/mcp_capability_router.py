...
class MCPCapabilityRouter:
    ...
    def _initialize_capabilities(self) -> dict[str, list[ServerCapability]]:
        ...
        return {
            ...
            "snowflake_admin": [
                ServerCapability(
                    "snowflake_admin", Capability.DATABASE_QUERY, 0.98, 0.99
                ),
                ServerCapability(
                    "snowflake_admin", Capability.DATA_ANALYSIS, 0.95, 0.98
                ),
                ServerCapability(
                    "snowflake_admin", Capability.REVENUE_ANALYSIS, 0.93, 0.97
                ),
            ],
            "slack": [
