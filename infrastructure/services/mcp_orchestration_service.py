...
Current size: 1368 lines

Recommended decomposition:
- mcp_orchestration_service_core.py - Core functionality
- mcp_orchestration_service_utils.py - Utility functions
...
class MCPOrchestrationService:
    ...
    def _get_fallback_server(self, primary_server: str) -> str | None:
        ...
        fallback_mapping = {
            ...
            "portkey_admin_official": "llm_service",
    ...
    async def route_cortex_request(
        ...
        """
        Intelligent routing for Lambda GPU requests with capability matching
