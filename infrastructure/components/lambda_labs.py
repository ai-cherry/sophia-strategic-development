...
class LambdaLabsComponent(BaseComponent):
    def __init__(self, name: str, opts: ResourceOptions = None):
        ...
        self.ssh_key = aws.ec2.KeyPair(ssh_key_name,
        ...
        self.instance = lambda_labs.Instance(instance_name,
        ...
        self.data_bucket = aws.s3.Bucket(bucket_name,
            bucket=bucket_name,
            acl="private",
            opts=component_opts
        )
        ...
        self.iam_role = aws.iam.Role(role_name,
        ...
        aws.iam.RolePolicyAttachment(f"{role_name}-s3-policy",
