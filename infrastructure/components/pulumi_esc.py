...
class PulumiEscComponent(BaseComponent):
    def __init__(self, name: str, opts: ResourceOptions = None):
        ...
        self.esc_environment = pulumiservice.Environment(
            f"sophia-{env}",
        ...
        for name, value in secrets_to_create.items():
            pulumiservice.EnvironmentSecret(
                f"sophia-{env}-{name}-secret",
                organization=pulumi_organization,
        ...
        self.stack = pulumiservice.Stack(
            f"sophia-{env}-stack",
            organization=pulumi_organization,
        ...
        self.stack_binding = pulumiservice.StackEnvironmentBinding(
            f"sophia-{env}-stack-binding",
            organization=pulumi_organization,
            project=pulumi_project,
