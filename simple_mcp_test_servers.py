            ...
            def do_GET(self):
                if self.path == '/health':
                    ...
                    self.wfile.write(json.dumps({
                        ...
                        "service": "Codacy MCP",
                        "port": 3008,
                        "features": ["code_analysis", "security_scan", "quality_check"]
                    }).encode())
            ...
            def do_GET(self):
                if self.path == '/health':
                    ...
                    self.wfile.write(json.dumps({
                        ...
                        "service": "Asana MCP",
                        "port": 3006,
                        "features": ["project_management", "task_tracking", "team_analytics"]
                    }).encode())
                    ...
                    self.wfile.write(json.dumps({
                        "projects": [
                            {"id": "1", "name": "Sophia AI Development", "status": "active"},
                            {"id": "2", "name": "Platform Integration", "status": "in_progress"}
                        ]
                    }).encode())
                else:
                    self.send_response(404)
            ...
            def do_GET(self):
                if self.path == '/health':
                    ...
                    self.wfile.write(json.dumps({
                        ...
                        "service": "Notion MCP",
                        "port": 3007,
                        "features": ["knowledge_management", "documentation", "content_sync"]
                    }).encode())
                    ...
                    self.wfile.write(json.dumps({
                        "pages": [
                            {"id": "1", "title": "Sophia AI Documentation", "type": "page"},
                            {"id": "2", "title": "Development Notes", "type": "database"}
                        ]
                    }).encode())
                else:
                    self.send_response(404)
