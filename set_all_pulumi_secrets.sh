...
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.snowflake.account "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.snowflake.user "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.snowflake.password "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.snowflake.database "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.snowflake.warehouse "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.snowflake.role "${github_secret}"
...
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.ai.snowflake_cortex.api_key "${github_secret}"
