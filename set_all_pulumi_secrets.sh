...
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.modern_stack.account "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.modern_stack.user "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.modern_stack.password "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.modern_stack.database "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.modern_stack.warehouse "${github_secret}"
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.infrastructure.modern_stack.role "${github_secret}"
...
pulumi env set scoobyjava-org/default/sophia-ai-production values.sophia.ai.modern_stack_cortex.api_key "${github_secret}"
