...
- dependencies_core.py - Core functionality
- dependencies_utils.py - Utility functions
...
from infrastructure.security.audit_logger import AuditEventType, info, warning
from infrastructure.security.rbac.models import ActionType, ResourceType, User
from infrastructure.security.rbac.service import get_rbac_service
...
def setup_rbac(
    ...
    """
    from infrastructure.security.rbac.service import initialize_rbac_service
