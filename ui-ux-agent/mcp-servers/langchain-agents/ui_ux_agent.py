    ...
    def _setup_routes(self):
        ...
        async def generate_component(request: CodeGenerationRequest):
            ...
            try:
                ...
                design_context = await self._get_design_context(
                    request.file_id, request.node_id
                )
        ...
        async def validate_design_system(request: dict):
            ...
            if not component_code:
                raise HTTPException(
                    status_code=400, detail="component_code is required"
                )
...
export default {component_name};"""
        ...
        return template.format(
            ...
            description=metadata.get(
                "description", f"Generated {component_name} component"
            ),
        )
