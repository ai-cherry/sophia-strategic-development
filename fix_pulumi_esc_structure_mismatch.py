        ...
        if result.returncode == 0:
            ...
            for line in lines:
                ...
                if not in_nested_structure:
                    ...
                    elif any(key in line for key in ['api_key', 'access_token', 'secret']) and 'sk-' in line or 'pcsk_' in line or len(line.split('"')[-2]) > 20:
                        top_level_real += 1
                else:
                    # Nested structure
                    if 'PLACEHOLDER_' in line:
...
def test_structure_fix():
    ...
    try:
        ...
        working_keys = ['openai_api_key', 'anthropic_api_key', 'gong_access_key', 'pinecone_api_key']
