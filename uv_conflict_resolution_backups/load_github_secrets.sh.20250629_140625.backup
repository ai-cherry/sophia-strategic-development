...
export SNOWFLAKE_ACCOUNT="$(gh secret get SNOWFLAKE_ACCOUNT --org ai-cherry 2>/dev/null || echo 'ZNB04675')"
export SNOWFLAKE_PASSWORD="$(gh secret get SNOWFLAKE_PASSWORD --org ai-cherry 2>/dev/null || echo 'loading_failed')"
