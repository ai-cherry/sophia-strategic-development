...
def test_imports():
    ...
    try:
        ...
        # Test core import
        from backend.agents.specialized.sales_intelligence_agent_core import SalesIntelligenceAgentCore
...
def test_utilities():
    ...
    try:
        ...
        from backend.agents.specialized.sales_intelligence_agent_models import DealRiskLevel, SalesStage
        
        # Test risk score calculation
        risk_factors = ["no_recent_activity", "negative_sentiment"]
        sentiment = {"stakeholder_1": 0.2, "stakeholder_2": 0.4}
        risk_score = SalesIntelligenceUtils.calculate_risk_score(risk_factors, sentiment)
...
def test_backward_compatibility():
    ...
    try:
        ...
        print(f"✅ Agent capabilities accessible: {len(capabilities.primary_capabilities)} capabilities")
