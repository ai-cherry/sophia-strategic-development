...
const SidebarNavigation = ({ 
  ...
  return (
    <aside 
      className={cn(
        // Base sidebar styles
        "flex flex-col h-full border-r border-gray-700 transition-all duration-300",
    ...
    >
      {/* Header */}
      <div className={cn(
        "flex items-center border-b border-gray-700 p-4",
        ...
        {onToggleCollapse && (
          <button
            ...
            className={cn(
              "p-1.5 rounded-lg text-gray-400 hover:text-white hover:bg-gray-800",
