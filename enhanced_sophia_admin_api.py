    ...
    async def natural_language_query(self, query: str) -> dict:
        ...
        try:
            ...
            if any(
                ...
                for keyword in ["apartment", "rental", "property", "multifamily"]
            ):
                ...
                return {
                    ...
                    "results": {
                        ...
                        "apartment_team_members": [
                            dict(row) for row in apartment_users
                        ],
                    },
                    "insights": {
            ...
            # Pay Ready specific queries
                ...
                keyword in query_lower
                for keyword in ["pay ready", "payready", "contract", "deal"]
            ):
            ...
            # Team performance queries
                ...
                keyword in query_lower
                for keyword in ["team", "sales", "performance", "top"]
            ):
            ...
            # Recent activity queries
                ...
                keyword in query_lower
                for keyword in ["recent", "latest", "today", "this week"]
            ):
                ...
                return {
                    ...
                    "results": {"recent_calls": [dict(row) for row in recent_calls]},
                    "insights": {"total_recent_calls": len(recent_calls)},
                }
            ...
            # General data overview
                ...
                return {
                    ...
                    "insights": {
                        "apartment_percentage": round(
                            (
                                overview_data.get("apartment_calls", 0)
                                / max(overview_data.get("total_calls", 1), 1)
                            )
                            * 100,
                            2,
                        )
...
def schema_mapping(table_name):
    ...
    try:
        ...
        result = loop.run_until_complete(
            sophia_api.get_schema_mapping_suggestions(table_name)
        )
        loop.close()
