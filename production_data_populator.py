            ...
            for j, scenario in enumerate(scenarios):
                ...
                try:
                    ...
                    """,
                        ...
                        "gong",
                        scenario["relevance"],
                        min(scenario["relevance"] + 0.05, 1.0),
                        datetime.utcnow(),
                        datetime.utcnow(),
                    )
                    stored_calls += 1
                    ...
                    if "competitive" in title.lower() or random.random() < 0.2:
                        ...
                        threat_level = (
                            "medium" if len(competitors_mentioned) == 1 else "high"
                        )
    ...
    async def get_final_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            stats["relevance_distribution"] = {
                row["category"]: row["count"] for row in relevance_dist
            }
            ...
            stats["deal_stages"] = {
                row["deal_progression_stage"]: row["count"] for row in stage_dist
            }
            ...
            stats["avg_deal_health_by_stage"] = {
                row["deal_progression_stage"]: row["avg_health"]
                for row in health_by_stage
            }
...
async def main():
    ...
    try:
        ...
        results_file = (
            f"/home/ubuntu/production_data_population_results_{timestamp}.json"
        )
