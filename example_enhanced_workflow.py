...
"""
    ...
    platform_contexts = [
        (
            "GitHub Issue",
            "Issue #123: Login form needs security updates",
            "✅ Context imported",
        ),
        (
            "Linear Task",
            "LIN-456: Implement new authentication flow",
            "✅ Context imported",
        ),
        (
            "Slack Discussion",
            "Team discussion about security requirements",
            "✅ Context imported",
        ),
        (
            "Jira Ticket",
            "SEC-789: Multi-factor authentication implementation",
            "✅ Context imported",
        ),
    ]
    ...
    advantages = [
        (
            "Latest AI Models",
            "Claude Sonnet 4 with intelligent routing",
            "❌ Zencoder: Not specified",
            "❌ cursor-companion: Uses Cursor's AI",
        ),
        (
            "Business Intelligence",
            "Real-time HubSpot, Gong, Snowflake integration",
            "❌ Zencoder: Code-focused only",
            "❌ cursor-companion: Code-focused only",
        ),
        (
            "Infrastructure Management",
            "Pulumi, Docker, K8s automation",
            "❌ Zencoder: Not available",
            "❌ cursor-companion: Not available",
        ),
        (
            "Executive Dashboard",
            "Live KPIs and business metrics",
            "❌ Zencoder: Not available",
            "❌ cursor-companion: Not available",
        ),
        (
            "Multi-Platform Support",
            "CLI + Web + Extensions + API",
            "✅ Zencoder: VS Code + Chrome",
            "✅ cursor-companion: Cursor only",
        ),
        (
            "Security & Compliance",
            "Enterprise-grade with Pulumi ESC",
            "✅ Zencoder: Enterprise features",
            "❌ cursor-companion: Basic",
        ),
        (
            "Context Management",
            "AI Memory + Business context",
            "✅ Zencoder: Platform integration",
            "✅ cursor-companion: Project rules",
        ),
    ]
