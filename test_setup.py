...
def main():
    ...
    if not missing and imports_ok:
        ...
        if "AI_PROVIDER" in missing:
            print(
                "3. Add at least one AI provider key (OpenAI, Anthropic, or Portkey+OpenRouter)"
            )
        print(
            "\nEdit your .env file with actual values from your organization secrets."
        )
        print(
            "Organization secrets page: https://github.com/organizations/ai-cherry/settings/secrets/actions"
        )
