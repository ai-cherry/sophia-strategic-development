#!/usr/bin/env python3
"""
HubSpot MCP Server - Standalone Implementation
No backend dependencies, uses standalone MCP base
"""
...
from standalone_mcp_base import MCPServerConfig, SimpleMCPServer


class HubSpotMCPServerStandalone(SimpleMCPServer):
    """HubSpot CRM integration MCP server - standalone version"""
    ...
    def _setup_server_routes(self):
        """Setup HubSpot-specific routes"""
        # Call parent to setup basic tool routes
        super()._setup_server_routes()
...
def main():
    """Main entry point"""
    server = HubSpotMCPServerStandalone()
    server.run()
