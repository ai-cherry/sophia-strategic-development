...
class TicketHandler(BaseHandler):
    ...
    def get_tickets_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "max_retries": {
                    "type": "integer",
                    "description": "Maximum number of retry attempts for rate limiting (default: 3)",
                },
                "retry_delay": {
                    "type": "number",
    ...
    def get_ticket_conversation_threads_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "ticket_id": {
                    "type": "string",
                    "description": "ID of the ticket to retrieve conversation threads for",
                }
            },
            "required": ["ticket_id"],
        }
    ...
    def get_tickets(self, arguments: dict[str, Any] | None) -> list[types.TextContent]:
        ...
        self.logger.debug(
            f"Getting tickets with criteria={criteria}, limit={limit}, max_retries={max_retries}, retry_delay={retry_delay}"
        )
    ...
    def _store_tickets_in_faiss(
        ...
        try:
            ...
            if data:
                metadata_extras = {"criteria": criteria, "limit": limit}
    ...
    def _store_ticket_threads_in_faiss(
        ...
        try:
            ...
            if threads_data:
                ...
                self.logger.debug(
                    f"Preparing to store {len(threads_data)} conversation threads in FAISS"
                )
                self.logger.debug(f"Metadata extras: {metadata_extras}")
