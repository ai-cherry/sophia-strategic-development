...
class AGUIMCPServer(StandardizedMCPServer):
    ...
    def _setup_routes(self) -> None:
        ...
        self.app.router.add_post('/sessions/{session_id}/input', self._handle_user_input)
    ...
    async def _websocket_handler(self, request: web.Request) -> web.WebSocketResponse:
        ...
        try:
            ...
            await self._send_event(session_id, AGUIEvent(
                event_type=AGUIEventType.SESSION_START,
                event_id=str(uuid.uuid4()),
                timestamp=datetime.utcnow().isoformat(),
                session_id=session_id,
                agent_id="sophia_ai",
                data={"message": "Session started", "capabilities": self._get_capabilities()}
            ))
    ...
    async def _handle_websocket_message(self, session_id: str, data: Dict[str, Any]) -> None:
            ...
            },
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "tool_id": {"type": "string", "description": "Unique tool execution ID"},
            ...
            },
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "status_message": {"type": "string", "description": "Current status message"}
                    },
    ...
    async def _send_text_message(self, session_id: str, message: str, metadata: Optional[Dict] = None) -> Dict[str, Any]:
    ...
    async def _update_ui_state(self, session_id: str, updates: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    async def _send_business_insight(self, session_id: str, insight_type: str, title: str, 
                                   content: str, priority: str = "medium", 
                                   action_items: List[str] = None) -> Dict[str, Any]:
