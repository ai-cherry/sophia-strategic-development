...
class EnhancedAGUIServer:
    ...
    async def websocket_handler(self, request):
        ...
        await self._send_to_websocket(session_id, AGUIEvent(
    ...
    async def _handle_websocket_message(self, session_id: str, message: str):
        ...
        try:
            ...
            logger.info("WebSocket message processed", 
                       session_id=session_id, event_type=event_type.value)
    ...
    async def send_business_insight(self, request):
        ...
        try:
            ...
            await self._broadcast_to_all(AGUIEvent(
    ...
    async def start_server(self):
        ...
        logger.info("Enhanced AG-UI MCP Server started", 
                   port=self.port, 
