...
Current size: 605 lines

Recommended decomposition:
- enhanced_ag_ui_mcp_server_core.py - Core functionality
- enhanced_ag_ui_mcp_server_utils.py - Utility functions
- enhanced_ag_ui_mcp_server_models.py - Data models
- enhanced_ag_ui_mcp_server_handlers.py - Request handlers
