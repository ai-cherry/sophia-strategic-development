...
"""
ModernStack Gong Connector

Utility module for accessing Gong call data directly from ModernStack structured tables.
This provides optimized access to processed Gong data for Sales Coach and Call Analysis agents.

Key Features:
- Direct access to structured Gong call data in ModernStack
...
- modern_stack_gong_connector_core.py - Core functionality
- modern_stack_gong_connector_utils.py - Utility functions
- modern_stack_gong_connector_models.py - Data models
- modern_stack_gong_connector_handlers.py - Request handlers
...
class ModernStackGongConnector:
    """
    Connector for accessing structured Gong data from ModernStack

    This class provides optimized methods for Sales Coach and Call Analysis agents
    to access processed Gong data with Lambda GPU AI enhancements.
    """
    ...
    async def initialize(self) -> None:
        """Initialize ModernStack connection for Gong data access"""
        if self.initialized:
            return
        ...
        try:
            ...
            logger.info("✅ ModernStack Gong connector initialized successfully")

        except Exception as e:
            logger.exception(f"Failed to initialize ModernStack Gong connector: {e}")
            raise
    ...
    async def close(self):
        ...
        if self.connection:
            ...
            self.initialized = False
            logger.info("ModernStack Gong connector closed")


# Global connector instance
gong_connector = ModernStackGongConnector()


async def get_gong_connector() -> ModernStackGongConnector:
