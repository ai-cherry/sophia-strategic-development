...
Migration guide:
1. Replace imports:
   OLD: from shared.utils.snowflake_cortex.pool import SnowflakeCortexPool
   NEW: from core.infra.cortex_gateway import get_gateway

2. Update usage:
   OLD: pool = SnowflakeCortexPool(); conn = pool.get_connection()
...
raise ImportError(
    "snowflake_cortex/pool.py is deprecated. Use 'from core.infra.cortex_gateway import get_gateway' instead. "
