#!/usr/bin/env python3
"""
Optimized Lambda GPU Service - Data Models
...
class CortexConfig:
    ...
    def __post_init__(self):
        if self.default_models is None:
            self.default_models = {
                CortexOperation.SENTIMENT_ANALYSIS: "modern_stack-arctic-sentiment",
                CortexOperation.TEXT_SUMMARIZATION: "modern_stack-arctic-summarize",
                CortexOperation.EMBEDDING_GENERATION: "e5-base-v2",
                CortexOperation.TRANSLATE: "modern_stack-arctic-translate",
                CortexOperation.COMPLETE: "modern_stack-arctic",
            }
