...
class N8NCliManager:
    ...
    def run_cli_command(self, command: List[str], cwd: Optional[Path] = None) -> Dict[str, Any]:
    ...
    async def export_workflows(self, output_dir: Optional[Path] = None) -> Dict[str, Any]:
    ...
    async def manage_credentials(self, action: str, credential_data: Optional[Dict] = None) -> Dict[str, Any]:
