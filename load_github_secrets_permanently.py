...
class PermanentSecretsLoader:
    ...
    def set_environment_variables(self, secrets: Dict[str, Any]) -> None:
        ...
        critical_secrets = [
            ...
            "GONG_ACCESS_KEY", "GONG_CLIENT_SECRET", "HUBSPOT_ACCESS_TOKEN",
            "LINEAR_API_KEY", "LAMBDA_API_KEY", "SNOWFLAKE_PASSWORD", 
            "PINECONE_API_KEY", "SLACK_BOT_TOKEN"
        ]
    ...
    def _flatten_esc_config(self, config: Dict[str, Any], prefix: str = "") -> Dict[str, Any]:
    ...
    def test_secret_access(self) -> Dict[str, bool]:
        ...
        critical_secrets = [
            "ANTHROPIC_API_KEY", "OPENAI_API_KEY", "GONG_ACCESS_KEY",
            "SNOWFLAKE_PASSWORD", "PINECONE_API_KEY"
        ]
        
        test_results = {}
        for secret in critical_secrets:
            value = os.getenv(secret)
            if value and value != "your-token-here" and not value.startswith("LOADED_FROM_GITHUB"):
    ...
    def create_permanent_env_file(self) -> None:
        ...
        critical_vars = [
            "PULUMI_ACCESS_TOKEN", "ANTHROPIC_API_KEY", "GEMINI_API_KEY",
            "OPENAI_API_KEY", "GONG_ACCESS_KEY", "GONG_CLIENT_SECRET",
            "HUBSPOT_ACCESS_TOKEN", "LINEAR_API_KEY", "LAMBDA_API_KEY",
            "SNOWFLAKE_ACCOUNT", "SNOWFLAKE_PASSWORD", "PINECONE_API_KEY",
