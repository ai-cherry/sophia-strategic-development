...
def main():
    ...
    parser.add_argument("--config", default="mcp_config.json", help="Path to MCP configuration file (default: mcp_config.json)")
    parser.add_argument("--compose", default="docker-compose.mcp.yml", help="Path to Docker Compose file (default: docker-compose.mcp.yml)")
