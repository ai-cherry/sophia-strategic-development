    ...
    def configure_branch_protection(self) -> bool:
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                logger.error(f"❌ Failed to configure branch protection: {response.status_code}")
        ...
        for config in security_configs:
            try:
                ...
                if response.status_code in [200, 201, 204]:
                    ...
                    logger.warning(f"⚠️ Could not enable {config['description']}: {response.status_code}")
...
"""
        ...
        for template in templates:
            try:
                ...
                if response.status_code in [200, 201]:
                    ...
                    logger.warning(f"⚠️ Could not create {template['name']}: {response.status_code}")
    ...
    def run_configuration(self) -> Dict:
        ...
        try:
            ...
            logger.info(f"🎉 GitHub security configuration completed: {results['success_rate']} successful")
