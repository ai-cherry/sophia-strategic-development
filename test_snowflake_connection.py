...
def test_snowflake_connection():
    ...
    try:
        ...
        if "404" in str(e):
            ...
            logger.error("💡 Warehouse error suggests warehouse doesn't exist or no access")
...
def main():
    ...
    if connection_success:
        logger.info("🎉 All tests passed! Snowflake configuration is working correctly.")
        return 0
    else:
        logger.error("❌ Connection test failed. Please check the error messages above.")
        return 1
