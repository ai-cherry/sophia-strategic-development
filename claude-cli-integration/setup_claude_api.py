...
def show_usage_examples():
    ...
    examples = [
        ("Code Generation", "./claude-cli-integration/claude chat \"Generate a Python function to parse CSV files\""),
        ("Design Analysis", "./claude-cli-integration/claude chat \"Analyze this React component design\""),
        ("Business Query", "python unified_ai_assistant.py \"Analyze our sales performance\""),
