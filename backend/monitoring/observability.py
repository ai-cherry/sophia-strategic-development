    ...
    async def record_metric(
        ...
        async with self._lock:
            ...
            if metric_type == "counter":
                ...
                self.aggregated[key]["min"] = min(self.aggregated[key].get("min", float('inf')), value)
                self.aggregated[key]["max"] = max(self.aggregated[key].get("max", float('-inf')), value)
...
class MonitoringDashboard:
    ...
    async def get_system_health(self) -> Dict[str, Any]:
        ...
        agent_success_rate = self._calculate_success_rate(aggregated, "agent.execution.success")
        llm_success_rate = self._calculate_success_rate(aggregated, "llm.request.success")
        ...
        return {
            "timestamp": datetime.utcnow().isoformat(),
            "status": self._determine_health_status(agent_success_rate, llm_success_rate),
            "metrics": {
