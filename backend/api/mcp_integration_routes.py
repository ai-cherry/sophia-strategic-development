...
- mcp_integration_routes_core.py - Core functionality
- mcp_integration_routes_utils.py - Utility functions
- mcp_integration_routes_models.py - Data models
- mcp_integration_routes_handlers.py - Request handlers
