...
- llm_strategy_routes_core.py - Core functionality
- llm_strategy_routes_utils.py - Utility functions
- llm_strategy_routes_models.py - Data models
- llm_strategy_routes_handlers.py - Request handlers
