...
async def get_slack_conversations(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to fetch Slack conversations")
...
async def sync_slack_data(
    ...
    try:
        ...
        from backend.scripts.transform_slack_linear_data import SlackLinearTransformationService
...
async def get_linear_stats(
    ...
    try:
        ...
        async def fetch_stats():
            ...
            issues_per_week = float(velocity_result[0][0]) if velocity_result and velocity_result[0][0] else 0.0
