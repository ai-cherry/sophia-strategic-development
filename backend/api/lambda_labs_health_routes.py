...
MCP_SERVERS = [
    ...
    {"id": "ai-memory", "name": "ai-memory-mcp", "port": 9000, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "figma-context", "name": "figma-context-mcp", "port": 9001, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "ui-ux-agent", "name": "ui-ux-agent-mcp", "port": 9002, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "codacy", "name": "codacy-mcp", "port": 3008, "health_path": "/api/v1/health", "instance_id": "mcp-prod"},  # Special port
    {"id": "asana", "name": "asana-mcp", "port": 9004, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "notion", "name": "notion-mcp", "port": 9005, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "linear", "name": "linear-mcp", "port": 9006, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "github", "name": "github-mcp", "port": 9007, "health_path": "/health", "instance_id": "platform-prod"},
    {"id": "slack", "name": "slack-mcp", "port": 9008, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "postgres", "name": "postgres-mcp", "port": 9009, "health_path": "/health", "instance_id": "platform-prod"},
    {"id": "sophia-data-intelligence", "name": "sophia-data-intelligence-mcp", "port": 9010, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "sophia-infrastructure", "name": "sophia-infrastructure-mcp", "port": 9011, "health_path": "/health", "instance_id": "platform-prod"},
    {"id": "snowflake-admin", "name": "snowflake-admin-mcp", "port": 9012, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "portkey-admin", "name": "portkey-admin-mcp", "port": 9013, "health_path": "/health", "instance_id": "platform-prod"},
    {"id": "openrouter-search", "name": "openrouter-search-mcp", "port": 9014, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "sophia-business-intelligence", "name": "sophia-business-intelligence-mcp", "port": 9015, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "sophia-ai-intelligence", "name": "sophia-ai-intelligence-mcp", "port": 9016, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "apify-intelligence", "name": "apify-intelligence-mcp", "port": 9017, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "bright-data", "name": "bright-data-mcp", "port": 9018, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "graphiti", "name": "graphiti-mcp", "port": 9019, "health_path": "/health", "instance_id": "mcp-prod"},
    
    # Strategic Enhancements (9020-9029) 
    {"id": "lambda-labs-cli", "name": "lambda-labs-cli-mcp", "port": 9040, "health_path": "/health", "instance_id": "platform-prod"},  # Updated port
    {"id": "snowflake-cli-enhanced", "name": "snowflake-cli-enhanced-mcp", "port": 9021, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "estuary-flow-cli", "name": "estuary-flow-cli-mcp", "port": 9022, "health_path": "/health", "instance_id": "platform-prod"},
    {"id": "pulumi", "name": "pulumi-mcp", "port": 9023, "health_path": "/health", "instance_id": "platform-prod"},
    {"id": "docker", "name": "docker-mcp", "port": 9024, "health_path": "/health", "instance_id": "platform-prod"},
    
    # Business Intelligence (9100-9119)
    {"id": "hubspot", "name": "hubspot-mcp", "port": 9100, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "gong", "name": "gong-mcp", "port": 9101, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "apollo-io", "name": "apollo-io-mcp", "port": 9102, "health_path": "/health", "instance_id": "mcp-prod"},
    
    # Data Integrations (9200-9219)
    {"id": "snowflake", "name": "snowflake-mcp", "port": 9200, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "snowflake-cortex", "name": "snowflake-cortex-mcp", "port": 9201, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "estuary", "name": "estuary-mcp", "port": 9202, "health_path": "/health", "instance_id": "ai-prod"},
    
    # Additional Servers
    {"id": "prompt-optimizer", "name": "prompt-optimizer-mcp", "port": 9030, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "mem0-bridge", "name": "mem0-bridge-mcp", "port": 9031, "health_path": "/health", "instance_id": "ai-prod"},
    
    # Backend MCP Servers
    {"id": "mem0-openmemory", "name": "mem0-openmemory-mcp", "port": 9032, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "mem0-persistent", "name": "mem0-persistent-mcp", "port": 9033, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "cortex-aisql", "name": "cortex-aisql-mcp", "port": 9034, "health_path": "/health", "instance_id": "ai-prod"},
    
    # Additional MCP Servers from mapping
    {"id": "hubspot-unified", "name": "hubspot-unified-mcp", "port": 9103, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "snowflake-unified", "name": "snowflake-unified-mcp", "port": 9203, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "code-modifier", "name": "code-modifier-mcp", "port": 9035, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "slack-integration", "name": "slack-integration-mcp", "port": 9104, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "slack-unified", "name": "slack-unified-mcp", "port": 9105, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "migration-orchestrator", "name": "migration-orchestrator-mcp", "port": 9036, "health_path": "/health", "instance_id": "platform-prod"},
    {"id": "intercom", "name": "intercom-mcp", "port": 9106, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "sophia-intelligence-unified", "name": "sophia-intelligence-unified-mcp", "port": 8081, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "huggingface-ai", "name": "huggingface-ai-mcp", "port": 9037, "health_path": "/health", "instance_id": "ai-prod"},
    {"id": "ag-ui", "name": "ag-ui-mcp", "port": 9038, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "salesforce", "name": "salesforce-mcp", "port": 9107, "health_path": "/health", "instance_id": "mcp-prod"},
    {"id": "v0dev", "name": "v0dev-mcp", "port": 9039, "health_path": "/health", "instance_id": "mcp-prod"},
]
