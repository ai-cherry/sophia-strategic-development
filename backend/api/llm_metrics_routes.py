...
class CostAlert(BaseModel):
    ...
    alert_type: str = Field(
        ..., pattern="^(daily_budget|monthly_budget|spike|projection)$"
    )
...
async def get_llm_stats(
    ...
    try:
        ...
        projected_monthly = (
            (monthly_cost / days_elapsed) * days_in_month if days_elapsed > 0 else 0
        )
...
async def get_cost_alerts(
    ...
    try:
        ...
        daily_cost = await cost_service._calculate_daily_cost()
        await cost_service._calculate_monthly_cost()
