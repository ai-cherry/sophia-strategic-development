    ...
    try:
        ...
        if request.personality_override:
            ...
            if user_profile:
                ...
                user_profile.preferred_personality = SophiaPersonality(
...
async def update_user_permissions(
    ...
    try:
        ...
        if not updater or updater.access_level != UserAccessLevel.CEO:
            raise HTTPException(
                status_code=403, detail="Only CEO can update user permissions"
            )
...
async def websocket_chat_endpoint(
    websocket: WebSocket, connection_id: str, user_id: str = "ceo"
):
    """
    ...
    try:
        ...
        while True:
            ...
            if message_type == "chat_message":
                ...
                await manager.send_personal_message(
                    {"type": "typing", "is_typing": True}, connection_id
                )
                ...
                try:
                    ...
                    await manager.send_personal_message(
                        {"type": "typing", "is_typing": False}, connection_id
                    )
