...
- smart_ai_routes_core.py - Core functionality
- smart_ai_routes_utils.py - Utility functions
- smart_ai_routes_models.py - Data models
- smart_ai_routes_handlers.py - Request handlers
