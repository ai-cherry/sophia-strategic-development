...
class EphemeralCredentialsMiddleware(BaseHTTPMiddleware):
    ...
    def _get_required_scopes(self, path: str) -> Optional[List[CredentialScope]]:
        """
...
def setup_ephemeral_credentials_middleware(
    app: FastAPI,
    credentials_service: Optional[EphemeralCredentialsService] = None,
    exclude_paths: Optional[List[str]] = None,
    required_scopes_by_path: Optional[Dict[str, List[CredentialScope]]] = None,
) -> None:
    """
