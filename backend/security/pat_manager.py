...
pat_days_until_expiry = Gauge(
    "snowflake_pat_days_until_expiry", "Days until PAT expiration", ["environment"]
)

pat_rotation_alerts = Gauge(
    "snowflake_pat_rotation_alerts", "Number of PATs needing rotation", ["severity"]
)
...
class SnowflakePATManager:
    """
    Manages Snowflake PAT lifecycle including validation, rotation tracking, and alerts.
    """

    def __init__(self):
        self.rotation_days = 90  # Snowflake PAT expires after 90 days
        ...
        logger.info(
            "SnowflakePATManager initialized",
    ...
    async def get_current_pat(self, environment: str = None) -> str:
        ...
        from backend.core.auto_esc_config import get_snowflake_pat
    ...
    def _validate_pat_format(self, pat: str) -> bool:
        ...
        # Basic validation - adjust based on actual Snowflake PAT format
        if len(pat) < 32:
            return False
    ...
    def _load_pat_metadata(self) -> dict[str, PATMetadata]:
        ...
        metadata_json = get_config_value("snowflake_pat_metadata")
    ...
    def _save_pat_metadata(self):
        ...
        set_config_value("snowflake_pat_metadata", json.dumps(data))
...
def get_pat_manager() -> SnowflakePATManager:
    ...
    if _pat_manager is None:
        _pat_manager = SnowflakePATManager()
    return _pat_manager
