...
async def get_dashboard_summary():
    ...
    return {"status": "ok", "kpi_summary": {
        "revenue_ytd": 12500000, "active_projects": 42, "system_health": 99.8 
    }}
...
async def post_search(query: dict):
    ...
    return {
        "status": "ok",
        "results": [
            {"title": f"Result for '{search_term}' 1", "snippet": "This is the first result."},
            {"title": f"Result for '{search_term}' 2", "snippet": "This is the second result."},
        ]
    }
