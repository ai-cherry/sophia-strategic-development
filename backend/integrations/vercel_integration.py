...
class VercelIntegration(Integration):
    ...
    async def get_projects(self) -> List[Dict[str, Any]]:
        ...
        try:.
            ...
            async with self.session.get(
                f"{self.base_url}/v9/projects", params=params
            ) as response:
    ...
    async def get_project(self, project_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:.
            ...
            async with self.session.get(
                f"{self.base_url}/v9/projects/{project_id}", params=params
            ) as response:
                if response.status == 200:
    ...
    async def get_deployments(
        ...
        try:.
            ...
            async with self.session.get(
                f"{self.base_url}/v6/deployments", params=params
            ) as response:
                if response.status == 200:
                    data = await response.json()
    ...
    async def get_deployment(self, deployment_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:.
            ...
            async with self.session.get(
                f"{self.base_url}/v13/deployments/{deployment_id}", params=params
            ) as response:
                if response.status == 200:
                    return await response.json()
                else:
    ...
    async def create_deployment(
        ...
        try:.
            ...
            async with self.session.post(
                f"{self.base_url}/v13/deployments", json=payload, params=params
            ) as response:
    ...
    async def get_domains(self, project_id: str = None) -> List[Dict[str, Any]]:
        ...
        try:.
            ...
            async with self.session.get(
                f"{self.base_url}/v5/domains", params=params
            ) as response:
                if response.status == 200:
                    data = await response.json()
    ...
    async def add_domain(self, name: str, project_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:.
            ...
            async with self.session.post(
                f"{self.base_url}/v5/domains", json=payload, params=params
            ) as response:
                if response.status in [200, 201]:
                    return await response.json()
                else:
    ...
    async def get_environment_variables(self, project_id: str) -> List[Dict[str, Any]]:
        ...
        try:.
            ...
            async with self.session.get(
                f"{self.base_url}/v9/projects/{project_id}/env", params=params
            ) as response:
                if response.status == 200:
                    data = await response.json()
                    ...
                    logger.error(
                        f"Failed to get environment variables: {response.status}"
                    )
                    return []
        except Exception as e:
        ...
        try:.
            ...
            async with self.session.post(
                ...
                if response.status in [200, 201]:
                    ...
                    logger.error(
                        f"Failed to set environment variable: {response.status}"
                    )
                    return None
        except Exception as e:
    ...
    async def get_logs(self, deployment_id: str) -> List[Dict[str, Any]]:
        ...
        try:.
            ...
            async with self.session.get(
                f"{self.base_url}/v2/deployments/{deployment_id}/events", params=params
            ) as response:
                if response.status == 200:
                    return await response.json()
                else:
