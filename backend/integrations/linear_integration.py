...
class LinearIntegration:
    ...
    async def create_issue(self, title: str, description: str, 
                          ...
                          priority: Optional[str] = None,
                          labels: Optional[List[str]] = None) -> Optional[LinearIssue]:
    ...
    async def get_issues(self, project_id: Optional[str] = None,
        ...
        try:
            ...
            if project_id:
                filtered_issues = [i for i in filtered_issues if i.project == project_id]
            if assignee_id:
                filtered_issues = [i for i in filtered_issues if i.assignee == assignee_id]
            if status:
    ...
    async def update_issue(self, issue_id: str, 
                          updates: Dict[str, Any]) -> Optional[LinearIssue]:
    ...
    async def create_project(self, name: str, description: str,
                           team_id: Optional[str] = None) -> Optional[LinearProject]:
    ...
    async def update_project(self, project_id: str,
                           updates: Dict[str, Any]) -> Optional[LinearProject]:
        ...
        try:
            ...
            matching_issues = [
                ...
                if query.lower() in issue.title.lower() or 
                   query.lower() in issue.description.lower()
            ]
    ...
    async def get_health_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self._config:
                health_status["workspace_id"] = self._config.get("workspace_id", "unknown")
...
async def create_project(name: str, description: str, **kwargs) -> Optional[LinearProject]:
