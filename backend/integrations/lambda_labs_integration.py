...
class LambdaLabsIntegration:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.default_instance_type = os.getenv("LAMBDA_LABS_INSTANCE_TYPE", "gpu_1x_a100_sxm4")
    ...
    async def create_instance(self, 
                            ...
                            ssh_key_names: Optional[List[str]] = None) -> Optional[LambdaLabsInstance]:
        ...
        try:
            response = await self._make_request("POST", "/instance-operations/launch", json=payload)
            ...
            if instance_data:
                ...
                for instance in instances:
                    if instance.id in instance_data:
                        logger.info(f"Created Lambda Labs instance: {instance.name} ({instance.id})")
                        return instance
    ...
    async def terminate_instance(self, instance_id: str) -> bool:
        ...
        try:
            await self._make_request("POST", "/instance-operations/terminate", json=payload)
    ...
    async def restart_instance(self, instance_id: str) -> bool:
        ...
        try:
            await self._make_request("POST", "/instance-operations/restart", json=payload)
...
async def create_sophia_instance(name: str = "sophia-ai-compute") -> Optional[LambdaLabsInstance]:
