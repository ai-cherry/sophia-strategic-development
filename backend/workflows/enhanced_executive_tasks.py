...
class ExecutiveBusinessIntelligence(BusinessTask):
    ...
    comparison_period: str | None = None  # For YoY, QoQ comparisons
    ...
    def _set_required_capabilities(self):
        ...
        self.required_capabilities = capability_map.get(
            self.executive_task_type, ["business_insights", "analytics"]
        )
...
class ExecutiveTaskFactory:
    ...
    def create_quarterly_review(
        focus_areas: list[str] | None = None, comparison_quarter: str | None = None
        ...
        return ExecutiveBusinessIntelligence(
            ...
            or ["revenue", "customer_health", "team_performance", "market_position"],
            required_capabilities=[],  # Will be set in post_init
        )

    @staticmethod
    def create_deal_risk_analysis(
        deal_ids: list[str] | None = None, include_sentiment: bool = True
    ) -> ExecutiveBusinessIntelligence:
    ...
    def create_revenue_forecast(
        horizon: str = "next_quarter", include_scenarios: bool = True
    ...
    def create_competitive_analysis(
        competitors: list[str] | None = None, focus_areas: list[str] | None = None
    ) -> ExecutiveBusinessIntelligence:
        ...
        return ExecutiveBusinessIntelligence(
            ...
            focus_areas=focus_areas
            or ["market_share", "product_features", "pricing", "customer_sentiment"],
            context_data=context_data,
            required_capabilities=[],
        )
    ...
    def create_team_performance_review(
        teams: list[str] | None = None, metrics: list[str] | None = None
    ) -> ExecutiveBusinessIntelligence:
