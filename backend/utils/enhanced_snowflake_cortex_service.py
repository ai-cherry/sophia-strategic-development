...
class EnhancedSnowflakeCortexService(SnowflakeCortexService):
    ...
    async def generate_embeddings(self, texts: List[str], use_cache: bool = True) -> List[EmbeddingResult]:
        """
    ...
    async def generate_ai_summary(self, content: str, context: str = "", summary_type: str = "general") -> str:
        """
