...
from ...models.chat_models import ChatSession, ChatMode, ChatContext, ChatConfiguration
...
class SessionManager:
    ...
    async def get_or_create_session(self, 
                                  ...
                                  configuration: Optional[ChatConfiguration] = None) -> ChatSession:
    ...
    async def get_session_count(self, mode_filter: Optional[ChatMode] = None) -> int:
