...
class SnowflakeConnectionPool:
    ...
    def __init__(self, config: Optional[PoolConfig] = None):
        ...
        logger.info(f"Snowflake connection pool initialized: {self.config.min_size}-{self.config.max_size} connections")
...
_global_pool: Optional[SnowflakeConnectionPool] = None
