...
class FoundationalKnowledgeService:
    ...
    async def sync_foundational_data_to_knowledge_base(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Foundational knowledge sync completed: {sync_results['synced_records']}/{sync_results['total_records']} records synced")
            return sync_results
    ...
    async def _get_foundational_records(self, data_type: FoundationalDataType) -> List[FoundationalRecord]:
    ...
    async def _convert_to_knowledge_document(self, record: FoundationalRecord) -> Dict[str, Any]:
    ...
    async def get_foundational_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for row in result:
                ...
                if last_updated and (not stats["last_sync"] or last_updated > stats["last_sync"]):
            ...
            return {"total_foundational_records": 0, "data_types": {}, "last_sync": None}
    ...
    async def update_foundational_record(
        ...
        try:
            ...
            records = await self._get_foundational_records(data_type)
            updated_record = next((r for r in records if r.record_id == record_id), None)
    ...
    async def generate_foundational_insights(self) -> Dict[str, Any]:
        ...
        try:
            ...
            employee_result = await self.cortex_service.execute_query(employee_insights_query)
            ...
            customer_result = await self.cortex_service.execute_query(customer_insights_query)
            ...
            competitive_result = await self.cortex_service.execute_query(competitive_query)
