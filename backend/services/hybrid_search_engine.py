...
class HybridSearchEngine:
    ...
    async def search(
        ...
        if self.personalization_weight > 0:
            fused_results = await self._personalize_results(
                fused_results,
                user_id
            )
    ...
    async def _bm25_search(
        ...
        """
        Perform BM25 keyword search using Snowflake.
        
        This uses Snowflake's built-in text search capabilities
