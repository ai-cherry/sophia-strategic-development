...
class CostEngineeringService:
    ...
    def __init__(self):
        ...
        self.cost_budget_daily: Optional[float] = None
        self.cost_budget_monthly: Optional[float] = None
    ...
    async def _check_semantic_cache(self, task_request: TaskRequest) -> Optional[Dict[str, Any]]:
    ...
    async def set_cost_budget(self, daily_budget: Optional[float] = None, monthly_budget: Optional[float] = None) -> None:
        """Set cost budgets"""
