...
class SemanticCache:
    ...
    def __init__(self, cortex_service: SnowflakeCortexService):
    ...
    async def _calculate_semantic_similarity(self, query1: str, query2: str) -> float:
        ...
        try:
            # Use Snowflake Cortex for semantic similarity
...
class EnhancedSearchService:
    ...
    def __init__(self):
        self.cortex = UnifiedMemoryServiceV2()
    ...
    async def _search_internal(self, request: SearchRequest) -> list[dict[str, Any]]:
        ...
        try:
            ...
            # Search Snowflake knowledge base
