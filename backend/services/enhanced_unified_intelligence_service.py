...
from backend.services.unified_intelligence_service import SophiaUnifiedIntelligenceService
...
class EnhancedUnifiedIntelligenceService(SophiaUnifiedIntelligenceService):
    ...
    async def unified_business_query(self, query: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.snowflake_integration and self._should_use_snowflake(query, context):
                try:
                    snowflake_results = await self._execute_snowflake_intelligence(query, context)
            ...
            if not snowflake_results or context.get("require_advanced_ai", False):
                ...
                if snowflake_results:
                    ...
                    enhanced_results = self._merge_intelligence_results(snowflake_results, base_results)
                else:
    ...
    def _should_use_snowflake(self, query: str, context: Dict[str, Any]) -> bool:
        ...
        snowflake_keywords = [
            'revenue', 'sales', 'deals', 'customers', 'financial',
            'performance', 'metrics', 'analytics', 'trends', 'forecast'
        ]
        
        query_lower = query.lower()
        has_business_keywords = any(keyword in query_lower for keyword in snowflake_keywords)
    ...
    async def _execute_snowflake_intelligence(self, query: str, context: Dict[str, Any]) -> Dict[str, Any]:
            ...
            if hasattr(self, 'snowflake_cortex') and self.snowflake_cortex:
                ...
                if results and len(results) > 0:
                    ...
                    return {
                        ...
                        "business_data": self._extract_business_data(row.get("INSIGHTS"))
                    }
    ...
    async def _simulate_snowflake_response(self, query: str, context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _merge_intelligence_results(self, snowflake_results: Dict, external_results: Dict) -> Dict[str, Any]:
        ...
        merged = {
            "unified_insights": {
                ...
                "synthesis": f"Combined analysis from Snowflake Cortex AI and external services"
            },
    ...
    def _extract_business_data(self, insights: Any) -> Dict[str, Any]:
        ...
        if isinstance(insights, dict):
            ...
            return {
                ...
                "has_metrics": "revenue" in insights.lower() or "sales" in insights.lower()
            }
        else:
    ...
    async def _get_ecosystem_health(self) -> Dict[str, Any]:
        ...
        health = {
            ...
            "components": {
                ...
                "constitutional_ai": "operational" if self.constitutional_ai else "disabled",
                "snowflake_cortex": "operational" if self.snowflake_integration else "disabled",
                "estuary_flow": "operational" if self.estuary_flow_enabled else "disabled",
                "portkey_gateway": "operational" if self.portkey_gateway else "disabled"
            },
    ...
    def _calculate_performance_score(self) -> float:
        ...
        violation_rate = self.performance_metrics['constitutional_violations'] / self.performance_metrics['total_queries']
        score -= violation_rate * 0.3
        
        # Reward Snowflake usage (more efficient)
        snowflake_rate = self.performance_metrics['snowflake_queries'] / self.performance_metrics['total_queries']
        ...
        if self.performance_metrics['average_response_time'] > 0:
            if self.performance_metrics['average_response_time'] < 0.2:  # Under 200ms
                score += 0.1
            elif self.performance_metrics['average_response_time'] > 1.0:  # Over 1 second
                score -= 0.2
        
        return max(0.0, min(1.0, score))
    
    def _update_performance_metrics(self, processing_time: float, results: Dict[str, Any]):
    ...
    async def get_performance_dashboard(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "constitutional_compliance": {
                ...
                "compliance_rate": (
                    1 - (self.performance_metrics['constitutional_violations'] / 
                         max(1, self.performance_metrics['total_queries']))
                ) * 100
            }
        }
...
_enhanced_unified_intelligence_service: Optional[EnhancedUnifiedIntelligenceService] = None

async def get_enhanced_unified_intelligence_service() -> EnhancedUnifiedIntelligenceService:
