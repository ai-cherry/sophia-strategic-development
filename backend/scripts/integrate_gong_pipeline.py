...
class GongPipelineIntegrator:
    ...
    async def integrate_component(self, component: IntegrationComponent) -> IntegrationResult:
...
async def main():
    ...
    parser.add_argument("--component", choices=[c.value for c in IntegrationComponent],
                       default="all", help="Component to integrate")
