...
class OptimizedHierarchicalCache:
            ...
            if self.redis_client:
                try:
                    ...
                    if l2_value_str:
                        ...
                        # Populate L1 cache
                        await self.l1_cache.set(full_key, l2_value, ttl=300)  # 5 min L1 TTL
    ...
    async def set_many(self, items: Dict[str, Any], namespace: str = "default", 
                       ttl: Optional[int] = None) -> None:
        """
...
async def set_cached(key: str, value: Any, namespace: str = "default", 
                     ttl: Optional[int] = None) -> None:
