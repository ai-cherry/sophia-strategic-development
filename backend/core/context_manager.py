...
class ContextManager:
    ...
    async def update_docker_context(
        ...
        **kwargs
        ...
        logger.debug(f"Updated Docker context for session {session_id}: {session.docker_context}")
    ...
    async def update_pulumi_context(
        ...
        **kwargs
        ...
        logger.debug(f"Updated Pulumi context for session {session_id}: {session.pulumi_context}")
    ...
    async def update_claude_context(
        ...
        **kwargs
        ...
        logger.debug(f"Updated Claude context for session {session_id}: {session.claude_context}")
