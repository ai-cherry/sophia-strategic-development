...
GRANT USAGE ON SCHEMA SOPHIA_CORE TO ROLE SOPHIA_UNIFIED_ROLE;
GRANT USAGE ON SCHEMA SOPHIA_AI_MEMORY TO ROLE SOPHIA_UNIFIED_ROLE;
GRANT USAGE ON SCHEMA SOPHIA_BUSINESS_INTELLIGENCE TO ROLE SOPHIA_UNIFIED_ROLE;
GRANT USAGE ON SCHEMA SOPHIA_PROJECT_MANAGEMENT TO ROLE SOPHIA_UNIFIED_ROLE;
GRANT USAGE ON SCHEMA SOPHIA_KNOWLEDGE_BASE TO ROLE SOPHIA_UNIFIED_ROLE;

-- Unified has full access
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_CORE TO ROLE SOPHIA_UNIFIED_ROLE;
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_AI_MEMORY TO ROLE SOPHIA_UNIFIED_ROLE;
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_BUSINESS_INTELLIGENCE TO ROLE SOPHIA_UNIFIED_ROLE;
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_PROJECT_MANAGEMENT TO ROLE SOPHIA_UNIFIED_ROLE;
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_KNOWLEDGE_BASE TO ROLE SOPHIA_UNIFIED_ROLE;
