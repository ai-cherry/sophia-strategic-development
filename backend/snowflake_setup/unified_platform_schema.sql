...
-- Executive KPIs - CEO Dashboard metrics
...
) COMMENT = 'Executive KPIs for CEO dashboard';
...
CREATE ROLE IF NOT EXISTS SOPHIA_CEO_ROLE;
...
GRANT USAGE ON SCHEMA SOPHIA_CORE TO SOPHIA_CEO_ROLE;
GRANT USAGE ON SCHEMA SOPHIA_AI_MEMORY TO SOPHIA_CEO_ROLE;
GRANT USAGE ON SCHEMA SOPHIA_BUSINESS_INTELLIGENCE TO SOPHIA_CEO_ROLE;
GRANT USAGE ON SCHEMA SOPHIA_PROJECT_MANAGEMENT TO SOPHIA_CEO_ROLE;
GRANT USAGE ON SCHEMA SOPHIA_KNOWLEDGE_BASE TO SOPHIA_CEO_ROLE;

-- CEO has full access
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_CORE TO SOPHIA_CEO_ROLE;
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_AI_MEMORY TO SOPHIA_CEO_ROLE;
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_BUSINESS_INTELLIGENCE TO SOPHIA_CEO_ROLE;
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_PROJECT_MANAGEMENT TO SOPHIA_CEO_ROLE;
GRANT ALL ON ALL TABLES IN SCHEMA SOPHIA_KNOWLEDGE_BASE TO SOPHIA_CEO_ROLE;
