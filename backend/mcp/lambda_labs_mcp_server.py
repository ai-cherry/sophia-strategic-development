...
class LambdaLabsMCPServer(BaseMCPServer):
        ...
        return [
            Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "instance_type": {"type": "string", "description": "Instance type name"},
                        "region": {"type": "string", "description": "Region name"},
                        "ssh_key_names": {"type": "array", "items": {"type": "string"}, "description": "SSH key names"},
    ...
    async def call_tool(self, request: CallToolRequest) -> List[TextContent]:
        ...
        if tool_name == "launch_instance":
            ...
            success = await self.integration_client.terminate_instance(instance_id=args.get("instance_id"))
