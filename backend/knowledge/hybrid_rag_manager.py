...
class HybridRAGManager:
    ...
    async def initialize(self):
        ...
        try:
            ...
            logger.info(
                "Hybrid RAG Manager initialized successfully (Pinecone & Snowflake)."
            )
    ...
    async def answer_complex_question(
        ...
        try:
            ...
            unstructured_context = [
                node.get_content() for node in vector_response.source_nodes
            ]
            ...
            structured_context = await snowflake_integration.execute_query(
                structured_query
            )
