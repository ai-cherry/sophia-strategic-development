...
class PerformanceResponse(BaseModel):
    connection_manager: Dict[str, Any] = Field(..., description="Connection manager metrics")
    ...
    gong_integration: Dict[str, Any] = Field(..., description="Gong integration metrics")
...
async def get_performance_metrics():
    ...
    try:
        ...
        return PerformanceResponse(
            ...
            gong_integration=gong_stats if isinstance(gong_stats, dict) else {"error": str(gong_stats)},
