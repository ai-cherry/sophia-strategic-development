...
from backend.app.dependencies import get_current_user, RateLimiter
...
class DocumentProcessResponse(BaseModel):
    ...
    processed_nodes: Optional[int] = Field(None, description="Number of processed nodes")
...
async def process_document(
    ...
    """
    logger.info(f"Processing document: {request.metadata.title if request.metadata else 'Untitled'}")
