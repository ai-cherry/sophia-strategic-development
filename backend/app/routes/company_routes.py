    ...
    try:
        ...
        performance = {
            "revenue": {
                ...
                "growth_rate": business_metrics.get("revenue", {}).get(
                    "growth_rate", 0
                ),
            ...
            "customers": {
                ...
                "new_this_month": business_metrics.get("customers", {}).get(
                    "new_this_month", 0
                ),
                "churn_rate": business_metrics.get("customers", {}).get(
                    "churn_rate", 0
                ),
            },
            "deals": {
                "in_pipeline": business_metrics.get("deals", {}).get("in_pipeline", 0),
                "closed_this_month": business_metrics.get("deals", {}).get(
                    "closed_won_this_month", 0
                ),
                "average_size": business_metrics.get("deals", {}).get(
                    "average_deal_size", 0
                ),
            },
        }
                ...
                if deal.get("properties", {}).get("dealstage") == "closedwon":
                    ...
                    if close_date:
                        ...
                        monthly_revenue[month_key] = (
                            monthly_revenue.get(month_key, 0) + amount
                        )
    ...
    try:
        ...
        async with hubspot:
            ...
            for contact in contacts:
                lifecycle_stage = contact.get("properties", {}).get(
                    "lifecyclestage", "lead"
                )
    ...
    try:
        ...
        return (
            jsonify(
                {
                    "summary": {
                        "total_pipeline_value": pipeline_analytics.get(
                            "open_deals_value", 0
                        ),
                        "total_deals": pipeline_analytics.get("open_deals_count", 0),
                        "closed_won_value": pipeline_analytics.get(
                            "closed_won_value", 0
                        ),
                        "closed_won_count": pipeline_analytics.get(
                            "closed_won_count", 0
                        ),
                    },
...
async def company_alerts():
    ...
    try:
        ...
        # Categorize alerts
        categorized_alerts = {"urgent": [], "warning": [], "info": []}
