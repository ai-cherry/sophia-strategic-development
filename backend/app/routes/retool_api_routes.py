...
async def get_client_health_portfolio():
    ...
    return [
        {"id": "acme_corp", "name": "Acme Corporation", "health_score": 55, "trend": "declining", "renewal_date": "2024-09-15"},
        {"id": "globex", "name": "Globex Inc.", "health_score": 92, "trend": "stable", "renewal_date": "2024-11-20"},
        {"id": "initech", "name": "Initech", "health_score": 78, "trend": "improving", "renewal_date": "2025-01-10"},
    ]
