...
from backend.core.auto_esc_config import config # Use the centralized, permanent secret solution
from backend.agents.core.agent_framework import agent_framework # The new Agno-based framework
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.error(f"Failed to initialize Pay Ready AI Agent System: {e}", exc_info=True)
