...
class EmotionalBoundaryChunker:
    ...
    async def chunk_by_emotional_shifts(
    ...
    def _analyze_emotions(self, text: str) -> Dict[str, Any]:
        ...
        intensity = (
            total_emotion_words / max(total_words / 10, 1) if total_words > 0 else 0
        )
        ...
        requires_attention = (
            primary_emotion in ["frustration", "concern", "urgency"] or intensity > 0.3
        )
