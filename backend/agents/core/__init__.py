...
# Import all agents
from backend.agents.docker_agent import docker_agent, docker_registration, DockerAgent
from backend.agents.pulumi_agent import pulumi_agent, pulumi_registration, PulumiAgent
...
async def initialize_agent_system():
    ...
    try:
        ...
        knowledge_agent = KnowledgeAgent(
            AgentConfig(name="knowledge_agent", version="1.0"),
