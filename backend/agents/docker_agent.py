...
class DockerAgent(BaseAgent):
    ...
    async def execute(self, command: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            # List containers
            if any(keyword in command_lower for keyword in ["list", "show", "get"]) and "container" in command_lower:
            ...
            # Build image
            elif "build" in command_lower and ("image" in command_lower or "docker" in command_lower):
    ...
    async def _switch_context(self, command: str, session_id: str) -> Dict[str, Any]:
        ...
        return {
            "status": "error",
            "message": "Unknown context switch target"
        }
    
    async def _docker_compose_operation(self, command: str, session_id: str) -> Dict[str, Any]:
    ...
    async def _dev_container_operation(self, command: str, session_id: str) -> Dict[str, Any]:
        ...
        if "open" in command or "start" in command:
            # Start dev container
            image = devcontainer_config.get("image", "mcr.microsoft.com/vscode/devcontainers/base")
        ...
        return {
            "status": "error",
            "message": "Unknown dev container operation"
        }
