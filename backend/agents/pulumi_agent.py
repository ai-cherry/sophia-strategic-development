...
class PulumiAgent(BaseAgent):
    ...
    async def execute(self, command: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # List resources
            elif any(keyword in command_lower for keyword in ["list", "show", "get"]) and "resource" in command_lower:
            ...
            # Stack operations
                ...
                if "create" in command_lower:
                    ...
                    return await self._get_stack_outputs(command, session_id, user_context)
                else:
    ...
    async def _deploy_stack(self, command: str, session_id: str, user_context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _list_resources(self, command: str, session_id: str, user_context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _create_stack(self, command: str, session_id: str) -> Dict[str, Any]:
        ...
        if not stack_name:
            return {
                "status": "error",
                "message": "Please specify a stack name"
            }
        ...
        try:
            ...
            return {
                "status": "error",
                "message": f"Failed to create stack: {str(e)}"
            }
    ...
    async def _select_stack(self, command: str, session_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "error",
                "message": f"Failed to select stack: {str(e)}"
            }
    
    async def _get_stack_outputs(self, command: str, session_id: str, user_context: Dict[str, Any]) -> Dict[str, Any]:
        """Get stack outputs"""
        stack_name = await self._get_stack_from_command_or_context(command, session_id)
    ...
    async def _list_stacks(self, session_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "error",
                "message": f"Failed to list stacks: {str(e)}"
            }
    
    async def _preview_changes(self, command: str, session_id: str, user_context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _refresh_stack(self, command: str, session_id: str, user_context: Dict[str, Any]) -> Dict[str, Any]:
        """Refresh stack state"""
        stack_name = await self._get_stack_from_command_or_context(command, session_id)
...
pulumi.export("deployment_name", deployment.metadata.name)"""
    ...
    async def _fix_with_copilot(self, command: str, session_id: str) -> Dict[str, Any]:
        ...
        result = await self.mcp_client.get_copilot_suggestions(
            ...
            stack_context=pulumi_context
        )
        
        return result
    
    async def _execute_direct_command(self, command: str, session_id: str) -> Dict[str, Any]:
    ...
    async def _get_stack_from_command_or_context(self, command: str, session_id: str) -> str:
