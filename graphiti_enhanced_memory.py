...
class GraphitiEnhancedMemory:
    ...
    async def store_business_entity(self, entity_type: str, name: str, 
    ...
    async def create_relationship(self, source_id: str, target_id: str, 
        ...
        try:
            ...
            logger.info(f"Created relationship: {relationship_type} (ID: {relationship_id})")
        ...
        try:
            ...
            def find_connections(current_id: str, depth: int):
                ...
                for rel in self.relationships.values():
                    if rel.source_node_id == current_id and rel.target_node_id in self.nodes:
                    ...
                    elif rel.target_node_id == current_id and rel.source_node_id in self.nodes:
    ...
    async def enhance_memory_with_graph(self, memory_content: str, memory_category: str,
