...
class UnifiedCommandInterface:
    ...
    async def _analyze_command(self, command: str) -> Dict[str, Any]:
        ...
        if any(keyword in command_lower for keyword in ["status", "health", "check", "system"]):
            return {
                "category": "system",
        ...
        elif any(keyword in command_lower for keyword in ["deploy", "infrastructure", "pulumi", "secret", "rotate"]):
            return {
    ...
    async def _execute_infrastructure_command(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Infrastructure command failed: {str(e)}", "action": "infrastructure"}
    
    async def _execute_code_command(self, command: str) -> Dict[str, Any]:
        """Execute code generation commands"""
        try:
            return {"status": "success", "message": "Code command processed", "action": "code_generation"}
        except Exception as e:
            logger.error(f"Code command failed: {e}")
            return {"status": "error", "message": f"Code command failed: {str(e)}", "action": "code_generation"}
    ...
    async def _execute_data_command(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Data command failed: {str(e)}", "action": "data_analysis"}
    ...
    async def _execute_crm_command(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"CRM command failed: {str(e)}", "action": "crm_operation"}
    ...
    async def _execute_project_command(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Project command failed: {str(e)}", "action": "project_management"}
    ...
    async def _execute_deployment_command(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Deployment command failed: {str(e)}", "action": "deployment"}
    ...
    async def _execute_communication_command(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Communication command failed: {str(e)}", "action": "communication"}
    
    async def _execute_general_command(self, command: str) -> Dict[str, Any]:
        """Execute general AI assistance commands"""
        try:
            return {"status": "success", "message": "Command processed", "action": "general_assistance"}
        except Exception as e:
            logger.error(f"General command failed: {e}")
            return {"status": "error", "message": f"General command failed: {str(e)}", "action": "general_assistance"}
