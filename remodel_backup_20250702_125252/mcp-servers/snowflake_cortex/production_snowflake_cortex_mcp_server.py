    ...
    def _validate_connection(self):
        ...
        try:
            with self._get_connection() as conn:
                ...
                logger.info(
                    f"Snowflake Cortex MCP connected successfully. Version: {version}"
                )
    ...
    async def cortex_vector_similarity(
        ...
        try:
            ...
            return {
                "status": "success",
                "similarity_score": (
                    float(result["SIMILARITY_SCORE"]) if result else 0.0
                ),
...
try:
    ...
    async def available_models():
        return {
            ...
            "embedding_models": ["e5-base-v2", "snowflake-arctic-embed-m"],
            "supported_functions": [
                "COMPLETE",
                "SENTIMENT",
                "TRANSLATE",
