...
Current size: 663 lines

Recommended decomposition:
- ag_ui_mcp_server_core.py - Core functionality
- ag_ui_mcp_server_utils.py - Utility functions
- ag_ui_mcp_server_models.py - Data models
- ag_ui_mcp_server_handlers.py - Request handlers
