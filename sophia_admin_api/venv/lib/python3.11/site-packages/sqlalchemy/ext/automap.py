...
"""Return the class name that should be used, given the name
    ...
    """by_module: ClassVar[ByModuleProperties]."""An instance of :class:`.util.Properties` containing a hierarchal
    ...
    """metadata: ClassVar[MetaData]."""Refers to the :class:`_schema.MetaData` collection that will be used
