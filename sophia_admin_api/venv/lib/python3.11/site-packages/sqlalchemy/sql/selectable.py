...
class HasPrefixes:
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    """Return a SELECT of this :class:`_expression.FromClause`.
        ...
        """def _refresh_for_new_column(self, column: ColumnElement[Any]) -> None:"""Given a column added to the .c collection of an underlying
...
class CTE(
    ...
    """class SelectsRows(ReturnsRows):"""Sub-base of ReturnsRows for elements that deliver rows
