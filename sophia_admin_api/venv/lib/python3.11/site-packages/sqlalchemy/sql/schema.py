...
class Table(DialectKWArgs, HasSchemaAttr, TableClause, inspection.Inspectable["Table"]):
    ...
    """indexes: Set[Index]."""A collection of all :class:`_schema.Index` objects associated with this
      :class:`_schema.Table`.
    ...
    """index: Optional[bool]."""The value of the :paramref:`_schema.Column.index` parameter.
       ...
       .. seealso::
           ...
           :attr:`_schema.Table.indexes`
    """unique: Optional[bool]."""The value of the :paramref:`_schema.Column.unique` parameter.
...
class Constraint(DialectKWArgs, HasConditionalDDL, SchemaItem):
    ...
    """elements: List[ForeignKey]."""A sequence of :class:`_schema.ForeignKey` objects.
