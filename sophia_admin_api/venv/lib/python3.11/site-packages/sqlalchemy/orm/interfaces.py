...
class PropComparator(SQLORMOperations[_T_co], Generic[_T_co], ColumnOperators):
    ...
    """Apply a modification to a given :class:`.ORMCompileState`.
        ...
        """class LoaderOption(CompileStateOption):"""Describe a loader modification to an ORM statement at compilation time.
    ...
    """update additional entity criteria options in the given
        ...
        """class UserDefinedOption(ORMOption):"""Base class for a user-defined option that can be consumed from the
