...
class MapperEvents(event.Events[mapperlib.Mapper[Any]]):
    ...
    def instrument_class(self, mapper: Mapper[_O], class_: Type[_O]) -> None:
        ...
        """def after_mapper_constructed(self, mapper: Mapper[_O], class_: Type[_O]) -> None:"""Receive a class and mapper when the :class:`_orm.Mapper` has been
        fully constructed.
        ...
        """def before_mapper_configured(self, mapper: Mapper[_O], class_: Type[_O]) -> None:"""Called right before a specific mapper is to be configured.
        ...
        *will* be fully available, since this style of relationship does not
        ...
        """def after_configured(self) -> None:"""Called after a series of mappers have been configured.
    ...
    """Intercept statement executions that occur on behalf of an
        ...
        """def after_commit(self, session: Session) -> None:"""Execute after a commit has occurred.
        ...
        """def after_rollback(self, session: Session) -> None:"""Execute after a real DBAPI rollback has occurred.
        ...
        """def after_flush(self, session: Session, flush_context: UOWTransaction) -> None:"""Execute after flush has completed, but before commit has been
        called.
    ...
    """Receive a collection append event.
        ...
        """def set(self, target: _O, value: _T, oldvalue: _T, initiator: Event) -> None:"""Receive a scalar set event.
        ...
        * The ``propagate=True`` flag is significant if the mapped class
        ...
        """def modified(self, target: _O, initiator: Event) -> None:"""Receive a 'modified' event.
        ...
        """class QueryEvents(event.Events[Query[Any]]):"""Represent events within the construction of a :class:`_query.Query`
    object.
