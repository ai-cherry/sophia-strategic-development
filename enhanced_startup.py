...
try:
    from backend.services.enhanced_sentiment_analyzer import enhanced_sentiment_analyzer, SentimentChannel
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        app_state["services"]["sentiment_analysis"] = "enhanced" if SENTIMENT_ANALYZER_AVAILABLE else "basic"
        ...
        logger.info(f"✅ Sentiment analysis framework: {app_state['services']['sentiment_analysis']}")
...
async def sentiment_analysis_status():
    ...
    return {
        ...
        "emotion_categories": [
            ...
            "optimistic", "anxious", "confident", "disappointed", "engaged", "neutral"
        ],
        "models": [
...
async def analyze_sentiment(data: Dict[str, Any]):
    ...
    try:
            ...
            try:
                ...
                return {
                    ...
                    "sentiment_analysis": {
                        ...
                        "emotion_categories": [emotion.value for emotion in result.emotion_categories],
                ...
                logger.error(f"Enhanced sentiment analysis failed, falling back to basic: {e}")
        ...
        if any(word in text_lower for word in ["excited", "great", "amazing", "fantastic"]):
            sentiment_score = 0.8
            emotions = ["excited"]
        elif any(word in text_lower for word in ["frustrated", "angry", "problem", "issue"]):
            sentiment_score = -0.6
            emotions = ["frustrated"]
        ...
        return {
            ...
            "sentiment_analysis": {
                ...
                "urgency_level": "high" if sentiment_score < -0.5 else "medium" if sentiment_score < -0.2 else "low",
    ...
    try:
        ...
        return {
            ...
            "batch_statistics": {
                ...
                "sentiment_range": {"min": min(sentiments), "max": max(sentiments)} if sentiments else None,
